...
async function getUserDetailData() {
  ...
  return (
    <>
    <UserContext.Provider value={{ userDetailData, setUserDetailData }}>
      <Container fluid>
      <div style={{width: '100%', backgroundColor: '#8d99ae', borderRadius: '5px'}}>
      <h3 style={{color: '#fff', textAlign: 'center', padding: '15px'}}><span></span><svg style={{height:'40px', width : '40px', padding: '5px', color: '#10d5cf'}} id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 119.92 122.88"><title>schedule-calendar</title><path d={headingSVG} /></svg>Shift Management <span style={{color:'#10d5cf'}}>System</span></h3>
      </div>
        <Row>
          <Col xs={2}>
              <SideBar/>
